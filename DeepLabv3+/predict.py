...
def parse_args():
    ...
    parser.add_argument("--weights-path", default="./save_weights/model_300.pth", help="segmentation weights path")
...
def get_segmentation_result(args):
    ...
    img = data_transform(original_img)   # 经过图像transforms处理；
